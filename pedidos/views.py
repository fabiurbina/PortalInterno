...
def indicadores_financeiro_dados(request):
    ...
    status_valores = {
        ...
        "A VENCER": float(total_a_vencer),
    }


    sla_valores = {
        "Dentro do Prazo":
            float(total_dentro_prazo),

        "Fora do Prazo":
            float(total_fora_prazo),
    }
    ...
    for item in dados_filtrados:
        ...
        evolucao_mensal[chave]["despesas"] += (
            valor_decimal(
                item.get("nValorTitulo")
            )
        )
